...
//в заголовочный файл.
	...
	//BOOK localBook; // инициализируется мусор
	static BOOK staticBook{ 2000, 4000,FICTION,"King","travel" };
	BOOK* dynamicBook = new BOOK; //  инициализируется мусором
	...
	static BOOK staticBook1;

	staticBook1.price = 10;
	staticBook1.category = NON_FICTION;
	staticBook1.year = 2022;
	strcpy(staticBook1.title, "Two Treatises of Government");
	strcpy(staticBook1.author, "John Locke");
	//printBook(&staticBook1);


	static BOOK localBook1;

	localBook1.price = 102;
	localBook1.category = NON_FICTION;
	localBook1.year = 2002;
	strcpy(localBook1.title, "Two Treatises of Government");
	strcpy(localBook1.author, "John Locke");
	//printBook(&localBook1);



	strcpy(dynamicBook->author, "Julius Caesar");
	strcpy(dynamicBook->title, "Bellum Gallicum");
	dynamicBook->year = 2018;
	dynamicBook->category = NON_FICTION;
	dynamicBook->price = 34;
	...
	////
	//edit_book(dynamicBook);
	//std::cout << "edited book:" << std::endl;
	//printBook(*dynamicBook);
//----------------------------------------------------------------------------------------------------------------
