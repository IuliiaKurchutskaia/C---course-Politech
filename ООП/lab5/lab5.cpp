...
//	List ls1;
//	
//	ls1.AddToTail(Circle(1, 1, 1.06));		//добавляем элементы в список
//	ls1.AddToTail(Circle(5, 5, 5));
//	ls1.AddToTail(Circle(2, 2, 2));
//	ls1.AddToTail(Circle(4, 4, 4));
//	ls1.AddToTail(Circle(2, 2, 2));
...
////std::cout << ls1;
//
//	//std::cout << ls1.RemoveAll(Circle(2, 2, 2)) << endl;     // удаляем все элементы, равные заданному
//	//std::cout << ls1 ;
//	//
//	// 2. Приведенный ниже код должен выполняться корректно	
//	//
